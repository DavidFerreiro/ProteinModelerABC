...
#Path
address<-paste("/Users/DavidFerreiro/Desktop/ProtModelv1.1/Examples/ProtModel/example1-TNF_Monkeypox/ABCOutputs", sep="")
setwd(address)
############################
...
write(paste("Goodness of fit of Real data",sep=""),"Results_text.txt",append=T)
