...
figureName1<-paste("./Results_SS.pdf",sep="")
pdf(figureName1)
par(mfrow=c(2,3))
...
try(legend(x="topright", inset = c(-0.05, -0.16), legend = c("Fitness", "LG", "Neutral"), xpd = TRUE, bty = "n", fill = c("grey30", "grey70", "grey90")), silent=TRUE)
invisible(dev.off())
############################
...
Retained_Simu <- 10000*ABC_Tolerance
