...
for x in Variables.StructuralSubstitutionModel.split(' '):
    if x == 'Fitness':
        ...
        with open('launch_N_CheckSimulations.py', 'w') as cN:
            ...
            cN.write('Functions.CheckSimuN(' + str(Variables.Total_E_simu) + ', ' + str(int(Variables.Total_E_simu) + int(Variables.NumberOfSimulations) + int(Variables.NumberOfSimulations)) + ')\n')
            cN.close()
    ...
    with open('order.py', 'w') as O:
        ...
        if Variables.SaveSimulations == 'Yes':
            ...
            if os.path.exists('ProtModel_Repeat_arguments.txt') == True:
                O.write('os.system("rm -r ProtModel_Repeat_arguments.txt")')
