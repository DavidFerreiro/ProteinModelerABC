...
def RealSummarySta(x):
    ...
    # Gratham Distance per site
    matriz = pd.read_csv("./bin/Gratham.csv")
    Total_Gratham_Position = []
    Gratham = 0
            ...
            for y in List2:
                if x[e] != y[e]:
                    if x[e] == '-' or y[e] == '-':
                        ...
                        Gratham = Gratham + matriz._get_value(row, x[e]) ** 2

            List2.remove(List2[0])
        Total_Gratham_Position.append(Gratham)
        Gratham = 0
    ...
    Gratham_Position_Mean = 0
    for x in range(0, Variables.NumAA):
        Gratham_Position_Mean = Gratham_Position_Mean + Total_Gratham_Position[x]
    Gratham_Position_Mean = Gratham_Position_Mean / Variables.NumAA
    if Variables.ShowInformationScreen == 'Yes':
        print('  Gratham distance mean calculated')

    # sd
    Gratham_Position_sd_Sum = 0
    for x in range(0, Variables.NumAA):
        Gratham_Position_sd_Sum = Gratham_Position_sd_Sum + ((Total_Gratham_Position[x] - Gratham_Position_Mean) * (
                    Total_Gratham_Position[x] - Gratham_Position_Mean))
    Gratham_Position_sd = (Gratham_Position_sd_Sum / Variables.NumAA) ** (0.5)
    if Variables.ShowInformationScreen == 'Yes':
        print('  Gratham distance sd calculated')

    # sk
    if Gratham_Position_sd == 0.0:
        Gratham_Position_sk = 0
        if Variables.ShowInformationScreen == 'Yes':
            print('  Gratham distance skewness calculated')
    else:
        Gratham_Position_sk_Sum = 0
        for x in range(0, Variables.NumAA):
            Gratham_Position_sk_Sum = Gratham_Position_sk_Sum + ((Total_Gratham_Position[x] - Gratham_Position_Mean) * (
                        Total_Gratham_Position[x] - Gratham_Position_Mean) * (Total_Gratham_Position[
                                                                                  x] - Gratham_Position_Mean))
        Gratham_Position_sk = (Gratham_Position_sk_Sum / Variables.NumAA) / (
                    Gratham_Position_sd * Gratham_Position_sd * Gratham_Position_sd)
        if Variables.ShowInformationScreen == 'Yes':
            print('  Gratham distance skewness calculated')

    # ku
    if Gratham_Position_sd == 0.0:
        Gratham_Position_ku = 0
        if Variables.ShowInformationScreen == 'Yes':
            print('  Gratham distance kurtosis calculated')
    else:
        Gratham_Position_ku_Sum = 0
        for x in range(0, Variables.NumAA):
            Gratham_Position_ku_Sum = Gratham_Position_ku_Sum + ((Total_Gratham_Position[x] - Gratham_Position_Mean) * (
                        Total_Gratham_Position[x] - Gratham_Position_Mean) * (Total_Gratham_Position[
                                                                                  x] - Gratham_Position_Mean) * (
                                                                             Total_Gratham_Position[
                                                                                 x] - Gratham_Position_Mean))
        Gratham_Position_ku = (Gratham_Position_ku_Sum / Variables.NumAA) / (
                    Gratham_Position_sd * Gratham_Position_sd * Gratham_Position_sd * Gratham_Position_sd)
        if Variables.ShowInformationScreen == 'Yes':
            print('  Gratham distance kurtosis calculated')
    ...
    for x in Variables.SummaryStatistics.split(' '):
        if x == '1':
            ...
            SS_HeadersRD.append('Gratham_mean_Position')
            SS_ValRD.append(str(Gratham_Position_Mean))
        elif x == '5':
            SS_HeadersRD.append('Gratham_sd_Position')
            SS_ValRD.append(str(Gratham_Position_sd))
        elif x == '6':
            SS_HeadersRD.append('Gratham_sk_Position')
            SS_ValRD.append(str(Gratham_Position_sk))
        elif x == '7':
            SS_HeadersRD.append('Gratham_ku_Position')
            SS_ValRD.append(str(Gratham_Position_ku))
...
def SimuSummarySta(zoe):
    ...
    for x in Variables.SummaryStatistics.split(' '):
        if x == '1':
            ...
            SS_csv.append(str(Gratham_Position_Mean))
        elif x == '5':
            SS_csv.append(str(Gratham_Position_sd))
        elif x == '6':
            SS_csv.append(str(Gratham_Position_sk))
        elif x == '7':
            SS_csv.append(str(Gratham_Position_ku))
...
def Head():
    ...
    for x in Variables.SummaryStatistics.split(' '):
        if x == '1':
            ...
            SS_Headers.append('Gratham_mean_Position')
        elif x == '5':
            SS_Headers.append('Gratham_sd_Position')
        elif x == '6':
            SS_Headers.append('Gratham_sk_Position')
        elif x == '7':
            SS_Headers.append('Gratham_ku_Position')
