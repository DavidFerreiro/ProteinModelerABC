...
if __name__ == "__main__":
    ...
    with open("ABCAnalysis.r", "w") as P:
        ...
        for x in Variables.SummaryStatistics.split(' '):
            if x == '1':
                ...
                SS_list.append('Gratham_mean_Position')
            elif x == '5':
                SS_list.append('Gratham_sd_Position')
            elif x == '6':
                SS_list.append('Gratham_sk_Position')
            elif x == '7':
                SS_list.append('Gratham_ku_Position')
    ...
    while attempt <= 10:
        ...
        try:
            ...
            print('ABC estimation fails. Consider increase the tolerace value or the number of simulations')
            sys.exit('ERROR!!! ABC estimation fails. Consider increase the tolerace value or the number of simulations')
    ...
    os.system('mv PCA.jpeg ABCOutputs/')
    for x in Models:
        os.system('mv Hist_' + str(x) + 'SSSimulations.jpeg ABCOutputs/')
    os.system('mv Results_text.txt ABCOutputs/')
    os.system('mv Results_ConfusionMatrix_' + str(Variables.ABCIterations) + 'samp_SSSimulations.jpeg ABCOutputs/')
    ...
    print("ABC analysis finished running\n")
