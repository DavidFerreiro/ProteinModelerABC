...
def main_window():
    ...
    def openSS():
        ...
        newWindows_valores.set("ΔG_mean ΔG_sd Number_Segregating_Sites Gratham_Distance_Position_mean Gratham_Distance_Position_sd Gratham_Distance_Position_sk Gratham_Distance_Position_ku")
        # crear la lista
