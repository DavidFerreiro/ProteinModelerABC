...
if __name__ == "__main__":
    ...
    with open('ProtModel.out', 'w') as Error:
        Error.close()
    # Call variables
    Variables.init()
    ...
    with open('ProtModel.out', 'a') as Error:
        ...
        Error.write('Starting simulations based on ' + str(Variables.SubstitutionModel) + ' amino acid substitution model\n')
        Error.close()
    ...
    with open('ProtModel.out', 'a') as Error:
        Error.write('Simulations based on ' + str(Variables.SubstitutionModel) + ' amino acid substitution models ended\n\n')
        Error.close()
    ...
    if Variables.LongSM == 0:
        ...
        with open('ProtModel.out', 'a') as Error:
            Error.write('Starting simulations based on ' + str(Variables.StructuralSubstitutionModel) + ' amino acid substitution model\n')
            Error.close()
        ...
        with open('ProtModel.out', 'a') as Error:
            Error.write('Starting simulations based on ' + str(Variables.StructuralSubstitutionModel.split(' ')[0]) + ' amino acid substitution model\n')
            Error.close()
        ...
        with open('ProtModel.out', 'a') as Error:
            Error.write('Simulations based on ' + str(Variables.StructuralSubstitutionModel.split(' ')[0]) + ' amino acid substitution models ended\n\n')
            Error.close()
        print('Simulations based on ' + str(Variables.StructuralSubstitutionModel.split(' ')[0]) + ' amino acid substitution models ended\n')

        with open('ProtModel.out', 'a') as Error:
            Error.write('Starting simulations based on ' + str(Variables.StructuralSubstitutionModel.split(' ')[1]) + ' amino acid substitution model\n')
            Error.close()
    ...
    with open('ProtModel.out', 'a') as Error:
        Error.write('Simulations based on ' + str(Variables.StructuralSubstitutionModel.split(' ')[1]) + ' amino acid substitution models ended\n\n')
        Error.close()
    ...
    if Variables.SaveSimulations == 'Yes':
        ...
        if os.path.exists('ProtModel_Repeat_arguments.txt') == True:
            os.system('rm -r ProtModel_Repeat_arguments.txt')
    ...
    with open("ABCAnalysis.r", "w") as P:
        ...
        P.write('try(legend(x="topright", inset = c(-0.05, -0.16), legend = c(' + Str_Models + '), xpd = TRUE, bty = "n", fill = c("grey30", "grey70", "grey90")), silent=TRUE)\n')
        P.write('invisible(dev.off())\n')
        P.write('############################\n\n')
        ...
        P.write('    SS_Tol <- cbind(SS_Tol, SS[1:Retained_Simu, 3])\n')
        P.write('  }\n')
        P.write('}\n')
    ...
    with open('ProtModel.out', 'a') as Error:
        ...
        Error.write('ProtModel has finished!!\n')
        Error.close()
    print('\nProtModel has finished!!')

    elapsed_time = time.time() - start_time
    with open('ProtModel.out', 'a') as Error:
        Error.write('ProtModel finished after: ' + str(elapsed_time) + ' seconds')
        Error.close()
    print('ProtModel finished after: ' + str(elapsed_time) + ' seconds')
