#!/bin/bash
#SBATCH --mem=100GB -n 500 -t 01:00:00
...
echo "_______________HIVw model_______________"
echo "Starting simulations based on 'HIVw' amino acid substitution model"
STARTTIME_0=$(date +%s)
srun python -c "import bin.Scripts.Functions; bin.Scripts.Functions.Cluster_Simu(0, 10000, 'HIVw')"
srun python -c "import bin.Scripts.Functions; bin.Scripts.Functions.CheckSimu(0, 10000, 'HIVw')"
echo "Simulations based on HIVw amino acid substitution model ended"
echo -e "\n"

echo "Calculating summary statistics of HIVw amino acid substitution model simulations"
srun python -c "import bin.Scripts.Functions; bin.Scripts.Functions.Cluster_SS(0, 10000)"
echo "Summary statistics calculations of HIVw amino acid substitution model simulations ended"
ENDTIME_0=$(date +%s)
echo -e "\n\n"
