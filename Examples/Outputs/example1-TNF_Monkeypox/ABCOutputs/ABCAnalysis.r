...
#Path
address<-paste("/mnt/netapp2/Store_uni/home/uvi/be/dfg/New_Analysis/example1-TNF_Monkeypox/ABCOutputs", sep="")
setwd(address)
############################
...
try(legend(x="topright", inset = c(-0.05, -0.16), legend = c("Fitness", "HIVw", "Neutral"), xpd = TRUE, bty = "n", fill = c('grey25', 'grey50', 'grey75')), silent=TRUE)
invisible(dev.off())
############################
