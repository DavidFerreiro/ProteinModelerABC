...
echo "_______________LG model_______________"
echo "Starting simulations based on 'LG' amino acid substitution model"
STARTTIME_0=$(date +%s)
srun python -c "import bin.Scripts.Functions; bin.Scripts.Functions.Cluster_Simu(0, 10000, 'LG')"
srun python -c "import bin.Scripts.Functions; bin.Scripts.Functions.CheckSimu(0, 10000, 'LG')"
echo "Simulations based on LG amino acid substitution model ended"
echo -e "\n"

echo "Calculating summary statistics of LG amino acid substitution model simulations"
srun python -c "import bin.Scripts.Functions; bin.Scripts.Functions.Cluster_SS(0, 10000)"
echo "Summary statistics calculations of LG amino acid substitution model simulations ended"
ENDTIME_0=$(date +%s)
echo -e "\n\n"
