...
echo "_______________WAG model_______________"
echo "Starting simulations based on 'WAG' amino acid substitution model"
STARTTIME_0=$(date +%s)
srun python -c "import bin.Scripts.Functions; bin.Scripts.Functions.Cluster_Simu(0, 10000, 'WAG')"
srun python -c "import bin.Scripts.Functions; bin.Scripts.Functions.CheckSimu(0, 10000, 'WAG')"
echo "Simulations based on WAG amino acid substitution model ended"
echo -e "\n"

echo "Calculating summary statistics of WAG amino acid substitution model simulations"
srun python -c "import bin.Scripts.Functions; bin.Scripts.Functions.Cluster_SS(0, 10000)"
echo "Summary statistics calculations of WAG amino acid substitution model simulations ended"
ENDTIME_0=$(date +%s)
echo -e "\n\n"
