#!/bin/bash
#SBATCH --mem=500GB -n 500 -t 24:00:00
...
echo "_______________RtRev model_______________"
echo "Starting simulations based on 'RtRev' amino acid substitution model"
STARTTIME_0=$(date +%s)
srun python -c "import bin.Scripts.Functions; bin.Scripts.Functions.Cluster_Simu(0, 10000, 'RtRev')"
srun python -c "import bin.Scripts.Functions; bin.Scripts.Functions.CheckSimu(0, 10000, 'RtRev')"
echo "Simulations based on RtRev amino acid substitution model ended"
echo -e "\n"

echo "Calculating summary statistics of RtRev amino acid substitution model simulations"
srun python -c "import bin.Scripts.Functions; bin.Scripts.Functions.Cluster_SS(0, 10000)"
echo "Summary statistics calculations of RtRev amino acid substitution model simulations ended"
ENDTIME_0=$(date +%s)
echo -e "\n\n"
