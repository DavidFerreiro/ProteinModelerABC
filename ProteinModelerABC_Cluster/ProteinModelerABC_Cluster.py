...
with open('launch_Simu.sh', 'w') as ls:
    ...
    if Variables.LongEM != 0:
        ...
        if rest != 0:
            ls.write('srun --mem=150GB -n ' + str(rest * Variables.LongEM) + ' -t 02:00:00 python launch_Rest_E_Simulations.py\n')
        ...
        if rest != 0:
            ls.write('srun --mem=150GB -n ' + str(rest * Variables.LongEM) + ' -t 02:00:00 python launch_Rest_E_SS.py\n')
