...
def err():
                ...
                for y in range(10, Variables.NumAA + 8):
                    if lines[x][y] == 'A' or lines[x][y] == 'R' or lines[x][y] == 'N' or lines[x][y] == 'D' or lines[x][y] == 'C' or lines[x][y] == 'Q' or lines[x][y] == 'E' or lines[x][y] == 'G' or lines[x][y] == 'H' or lines[x][y] == 'I' or lines[x][y] == 'L' or lines[x][y] == 'K' or lines[x][y] == 'M' or lines[x][y] == 'F' or lines[x][y] == 'P' or lines[x][y] == 'S' or lines[x][y] == 'T' or lines[x][y] == 'W' or lines[x][y] == 'Y' or lines[x][y] == 'V' or lines[x][y] == '-':
                        ...
                        #with open('ProtModel.out', 'a') as Error:
                            ...
                            #Error.write('Error in alignment file: ' + lines[x][y] + ' character is not allow\n')
                            #Error.close()
    ...
    if isinstance(Variables.TEMP, float) == True:
        #with open('ProteinModelerABC.out', 'a') as Error:
            #Error.write('Thermodynamic temperature set at ' + str(Variables.TEMP) + '\n')
            #Error.close()
        print('Thermodynamic temperature set at ' + str(Variables.TEMP))
    else:
        #with open('ProteinModelerABC.out', 'a') as Error:
    ...
    if isinstance(Variables.S0, float) == True:
        #with open('ProteinModelerABC.out', 'a') as Error:
            #Error.write('Unfolded protein configurational entropy per residue set at ' + str(Variables.S0) + '\n')
            #Error.close()
        print('Unfolded protein configurational entropy per residue set at ' + str(Variables.S0))
    else:
        #with open('ProteinModelerABC.out', 'a') as Error:
    ...
    if isinstance(Variables.SC1, float) == True:
        #with open('ProteinModelerABC.out', 'a') as Error:
            #Error.write('Misfolded protein configurational entropy per residue set at ' + str(Variables.SC1) + '\n')
            #Error.close()
        print('Misfolded protein configurational entropy per residue set at ' + str(Variables.SC1))
    else:
        #with open('ProteinModelerABC.out', 'a') as Error:
    ...
    if isinstance(Variables.SC0, float) == True:
        #with open('ProteinModelerABC.out', 'a') as Error:
            #Error.write('Misfolded protein entropy offset set at ' + str(Variables.SC0) + '\n')
            #Error.close()
        print('Misfolded protein entropy offset set at ' + str(Variables.SC0))
    else:
        #with open('ProteinModelerABC.out', 'a') as Error:
    ...
    if isinstance(Variables.NPOP, int) == True:
        #with open('ProteinModelerABC.out', 'a') as Error:
            #Error.write('The population size to simulate molecular evolution under Fitness site-dependent SCS model set at ' + str(Variables.NPOP) + '\n')
            #Error.close()
        print('The population size to simulate molecular evolution under Fitness site-dependent SCS model set at ' + str(Variables.NPOP))
    else:
        #with open('ProteinModelerABC.out', 'a') as Error:
    ...
    if Variables.ABCIterations < Variables.NumberOfSimulations:
        ...
        #with open('ProtModel.out', 'a') as Error:
            #Error.write('ABC iterations value must be equal or lower than the number of simulations\n')
