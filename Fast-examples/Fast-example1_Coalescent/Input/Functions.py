...
def E_Simu(zoe):
    with open('ProteinModelerABC_arguments.txt','r') as f:
        lines = f.readlines()
...
def S_Simu_1(zoe):
    ...
    with open('ProteinModelerABC_S_arguments.txt', 'r') as f:
        data = f.readlines()
...
def S_Simu_F(zoe):
    ...
    with open('ProteinModelerABC_S_arguments0.txt', 'r') as f:
        data = f.readlines()
        os.system("./bin/Protein_EvolverABC/ProteinEvolverProtABC1.2.0 " + data[zoe])
        # print('Simulation # ' + str(data[zoe].split(':')[1][:-1]))
        if (zoe + 1) == 1:
...
def S_Simu_N(zoe):
    ...
    with open('ProteinModelerABC_S_arguments1.txt', 'r') as f:
        data = f.readlines()
        os.system("./bin/Protein_EvolverABC/ProteinEvolverProtABC1.2.0 " + data[zoe])
        # print('Simulation # ' + str(data[zoe].split(':')[1][:-1]))
        if (zoe + 1) == 1:
...
def CheckSimu():
                ...
                try:
                    with open("ProteinModelerABC_arguments.txt", "r") as openfile:
                        for line in openfile:
                            if num_b in line:
                                with open("ProteinModelerABC_Repeat_arguments.txt", "a") as R_file:
                                    R_file.write(line)
                except:
                    pass
    ...
    if len(NumberofRepeats) != 0:
        #with open('Test.txt','w') as f:
            #f.write(str(NumberofRepeats))
            #f.close()
        #print(len(NumberofRepeats))
        #print(NumberofRepeats)

        #Comprobar la clase de simulacion
        with open("ProteinModelerABC_Repeat_arguments.txt", "r") as openfile:
            for line in openfile:
                if 'Pop_evol.in' in line:
                    with open("ProteinModelerABC_S_arguments0.txt", "r") as openf:
                    ...
                    with open("ProteinModelerABC_S_arguments1.txt", "r") as openf1:
