...
#Path
address<-paste("/Users/DavidFerreiro/Desktop/ProteinModelerABC/Examples/Fast-examples/Fast-example1_Coalescent/ABCOutputs", sep="")
setwd(address)
############################
...
try(legend(x="topright", inset = c(-0.05, -0.16), legend = c("Fitness", "JTT", "Neutral"), xpd = TRUE, bty = "n", fill = c('grey25', 'grey50', 'grey75')), silent=TRUE)
invisible(dev.off())
############################
